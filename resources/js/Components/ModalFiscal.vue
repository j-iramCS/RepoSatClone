...
<template>
    <div>
        <!-- BotÃ³n principal con mejor feedback tÃ¡ctil -->
        <button @click="openModal" :class="classcustom">
            ...
            >
                <div class="h-full flex flex-col">
                    ...
                    <template v-if="buttons">
                        <div
                            class="sticky bottom-0 bg-white p-4 border-t flex justify-end space-x-3"
                        >
                            <button
                                @click="closeModal"
