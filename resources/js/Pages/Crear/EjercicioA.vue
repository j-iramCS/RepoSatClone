<template>
    <Main>
        <div
            class="max-w-6xl mx-auto rounded-lg shadow-md bg-gradient-to-br from-purple-600 to-indigo-600"
        >
            <!-- Header -->
                ...
                <button
                    ...
                    :class="
                        activeTab === 'identificacion'
                            ...
                            : 'text-white'
                    "
                    @click="activeTab = 'identificacion'"
                >
                    Identificación
                </button>
                <button
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <div class="flex items-center gap-2">
                                        <p
                                            class="text-sm font-semibold m-0 p-0 text-white"
                                        >
                                            RFC
                                        </p>
                                        <Tooltip
                                    ...
                                    <Input
                                        type="text"
                                        v-model="formEjercicio.inputRFC"
                                        custom-class="mt-2"
                                        placeholder="Ingrese su RFC"
                                        clearable
                                        default-value="XAXX010101000"
                                        :required="true"
                                        :rules="{
                                ...
                                <div>
                                    ...
                                    <Input
                                        type="text"
                                        v-model="formEjercicio.inputCURP"
                                        custom-class="mt-2"
                                        placeholder="Ingrese su RFC"
                                        clearable
                                        default-value="XXXXXXXXXXXXXXXXXX"
                                        :required="true"
                                        :rules="{
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <Input
                                        type="text"
                                        v-model="
                                            formEjercicio.inputApellidoPaterno
                                        "
                                        custom-class="mt-2"
                                ...
                                <div>
                                    ...
                                    <Input
                                        type="text"
                                        v-model="
                                            formEjercicio.inputApellidoMaterno
                                        "
                                        custom-class="mt-2"
                                        placeholder="Ingresa un apellido"
                                        clearable
                                ...
                                <div>
                                    ...
                                    <Input
                                        type="text"
                                        v-model="formEjercicio.inputNombres"
                                        custom-class="mt-2"
                                        placeholder="Ingresa un apellido"
                                        clearable
                                        default-value="NNN"
                    ...
                    <div class="bg-slate-900 p-4 rounded-lg">
                        <div class="grid grid-cols-3 gap-4">
                            <div>
                                ...
                                <Select
                                    v-model="
                                        formEjercicio.selectedTipoDeclaracion
                                    "
                                    :options="optionsTipoDeclaracion"
                                    :searchable="false"
                                    placeholder="Selecciona una declaración"
                                    :required="true"
                                />
                            </div>
                            <div>
                                ...
                                <!-- selec -->
                                <Select
                                    v-model="formEjercicio.selectedEjercicio"
                            ...
                            <div>
                                ...
                                <!-- selec -->
                                <Select
                                    v-model="formEjercicio.selectedPeriodo"
                        ...
                        <div class="bg-slate-900 p-4 rounded-lg">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <!-- selec -->
                                    <Select
                                        v-model="formEjercicio.selectedIngresos"
                                ...
                                <div class="">
                                    ...
                                    <Input
                                        type="number"
                                        v-model="
                                            formEjercicio.inputIngresoPeriodoAnterior
                                        "
                                        custom-class="mt-2"
                                        placeholder="Ingresa el valor correspondiente"
                                        clearable
                                        :required="true"
                                    />
                                </div>
                                ...
                                <div class="">
                                    ...
                                    <Input
                                        type="number"
                                        v-model="
                                            formEjercicio.inputIngresoPeriodo
                                        "
                                        custom-class="mt-2"
                                        placeholder="Ingresa el valor correspondiente"
                                        clearable
                                ...
                                <div class="">
                                    ...
                                    <Input
                                        type="number"
                                        v-model="
                                            formEjercicio.inputTotalIngresos
                                        "
                                        custom-class="mt-2"
                                        placeholder="Ingresa el valor correspondiente"
                                        clearable
                                ...
                                <div class="">
                                    ...
                                    <Input
                                        type="number"
                                        v-model="
                                            formEjercicio.inputTotalIngresosAcumulables
                                        "
                                        custom-class="mt-2"
                                        placeholder="Ingresa el valor correspondiente"
                                        clearable
                                ...
                                <div class="col-span-2">
                                    ...
                                    <Input
                                        type="number"
                                        v-model="
                                            formEjercicio.inputComprasGastosPeriodoAnterior
                                        "
                                        custom-class="mt-2"
                                        placeholder="Ingresa el valor correspondiente"
                                        clearable
                                ...
                                <div class="">
                                    ...
                                    <Input
                                        type="number"
                                        v-model="
                                            formEjercicio.inputComprasGastosPeriodo
                                        "
                                        custom-class="mt-2"
                                        placeholder="Ingresa el valor correspondiente"
                                        clearable
                                ...
                                <div class="">
                                    ...
                                    <Input
                                        type="number"
                                        v-model="
                                            formEjercicio.inputTotalComprasGastos
                                        "
                                        custom-class="mt-2"
                                        placeholder="Ingresa el valor correspondiente"
                                        clearable
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <Input
                                        type="number"
                                        v-model="
                                            formEjercicio.inputDeduccionInversionesEjercicioAnterior
                                        "
                                        custom-class="mt-2"
                                        placeholder="Ingresa el valor correspondiente"
                                        clearable
                                ...
                                <div class="col-span-2">
                                    ...
                                    <Input
                                        type="number"
                                        v-model="
                                            formEjercicio.inputDeduccionInmediataInversiones
                                        "
                                        custom-class="mt-2"
                                        placeholder="Ingresa el valor correspondiente"
                                        clearable
                                ...
                                <div class="col-span-2">
                                    ...
                                    <Select
                                        v-model="
                                            formEjercicio.selectedDeduccionFacilidadesAdministrativas
                                        "
                                        :options="optionsIngresos"
                                        :searchable="false"
                                        placeholder="Selecciona una opción"
                                ...
                                <div class="col-span-2">
                                    ...
                                    <Input
                                        type="number"
                                        v-model="
                                            formEjercicio.inputParticipacionTrabajadoresUtilidades
                                        "
                                        custom-class="mt-2"
                                        placeholder="Ingresa el valor correspondiente"
                                        clearable
                                ...
                                <div class="col-span-2">
                                    ...
                                    <Input
                                        type="number"
                                        v-model="
                                            formEjercicio.inputBaseGravablePagoProvisional
                                        "
                                        custom-class="mt-2"
                                        placeholder="Ingresa el valor correspondiente"
                                        clearable
                    ...
                    <div class="bg-slate-900 p-4 rounded-lg">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="formEjercicio.inputISRcausado"
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                                    :required="true"
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="
                                        formEjercicio.inputISRretenidoPeriodosAnteriores
                                    "
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="
                                        formEjercicio.inputISRretenidoPeriodo
                                    "
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="
                                        formEjercicio.inputImpuestoRetenido
                                    "
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="formEjercicio.inputISRcargo"
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                                    :required="true"
                    ...
                    <div class="bg-slate-900 p-4 rounded-lg">
                        ...
                        >
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="formEjercicio.inputACargo"
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                                />
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="
                                        formEjercicio.inputParteActualizada
                                    "
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="formEjercicio.inputRecargos"
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                                />
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="
                                        formEjercicio.inputTotalContribuciones
                                    "
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="
                                        formEjercicio.inputTotalAplicaciones
                                    "
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="formEjercicio.inputCantidadACargo"
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                                />
                            ...
                            <div class="">
                                ...
                                <Select
                                    v-model="
                                        formEjercicio.selectedOptaPagarParcialidades
                                    "
                                    :options="optionsIngresos"
                                    :searchable="false"
                                    placeholder="Selecciona una opción"
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="formEjercicio.inputCantidadAPagar"
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                                />
                        ...
                        >
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="
                                        formEjercicio.inputActividadesGravadasTasa16
                                    "
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="
                                        formEjercicio.inputActividadesGravadasTasa0
                                    "
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="
                                        formEjercicio.inputActividadesExentas
                                    "
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="
                                        formEjercicio.inputIVACobradoPeriodoTasa16
                                    "
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="
                                        formEjercicio.inputIVAAcreditablePeriodo
                                    "
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="formEjercicio.inputIVARetenido"
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                                />
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="formEjercicio.inputCantidadACargo2"
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                                />
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="formEjercicio.inputImpuestoACargo2"
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                                />
                    ...
                    <div class="bg-slate-900 p-4 rounded-lg">
                        ...
                        >
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="formEjercicio.inputACargo2"
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                                />
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="
                                        formEjercicio.inputParteActualizada2
                                    "
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="formEjercicio.inputRecargos2"
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                                />
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="
                                        formEjercicio.inputTotalContribuciones2
                                    "
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="
                                        formEjercicio.inputTotalAplicaciones2
                                    "
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                            ...
                            <div class="">
                                ...
                                <Input
                                    type="number"
                                    v-model="formEjercicio.inputCantidadAPagar2"
                                    custom-class="mt-2"
                                    placeholder="Ingresa el valor correspondiente"
                                    clearable
                                />
...
const activeTab = ref("identificacion"); // Estado

// const inputRFC = ref<string>(""); // Estado para el input de RFC
// const inputCURP = ref<string>(""); // Estado para el input de CURP
// const inputApellidoPaterno = ref<string>(""); // Estado para el input de apellido paterno
// const inputApellidoMaterno = ref<string>(""); // Estado para el input de apellido materno
// const inputNombres = ref<string>(""); // Estado para el input de nombre

// const inputIngresoPeriodoAnterior = ref<string>(""); // Estado para el input de ingresos del periodo anteriores
// const inputIngresoPeriodo = ref<string>(""); // Estado para el input de ingresos del periodo actual
// const inputTotalIngresos = ref<string>(""); // Estado para el input de total de ingresos
// const inputTotalIngresosAcumulables = ref<string>(""); // Estado para el input de total de ingresos acumulables
// const inputComprasGastosPeriodoAnterior = ref<string>(""); // Estado para el input de compras y gastos del periodo anterior
// const inputComprasGastosPeriodo = ref<string>(""); // Estado para el input de compras y gastos del periodo actual
// const inputTotalComprasGastos = ref<string>(""); // Estado para el input de total de compras y gastos

// const inputDeduccionInversionesEjercicioAnterior = ref<string>(""); // Estado para el input de deducción de inversiones de ejercicios anteriores
// const inputDeduccionInmediataInversiones = ref<string>(""); // Estado para el input de deducción inmediata de inversiones
// const selectedDeduccionFacilidadesAdministrativas = ref<string>(""); // Estado para el input de deducción de facilidades administrativas
// const inputParticipacionTrabajadoresUtilidades = ref<string>(""); // Estado para el input de participación de trabajadores en utilidades
// const inputBaseGravablePagoProvisional = ref<string>(""); // Estado para el input de base gravable del pago provisional

// const inputISRcausado = ref<string>(""); // Estado para el input de ISR causado
// const inputISRretenidoPeriodosAnteriores = ref<string>(""); // Estado para el input de ISR retenido de periodos anteriores
// const inputISRretenidoPeriodo = ref<string>(""); // Estado para el input de ISR retenido del periodo
// const inputImpuestoRetenido = ref<string>(""); // Estado para el input de impuesto retenido
// const inputISRcargo = ref<string>(""); // Estado para el input de ISR a cargo

// const selectedTipoDeclaracion = ref(null);
// const selectedEjercicio = ref(null);
// const selectedPeriodo = ref(null);
// const selectedIngresos = ref(null);

// const inputACargo = ref<string>(""); // Estado para el input de a cargo
// const inputParteActualizada = ref<string>(""); // Estado para el input de parte actualizada
// const inputRecargos = ref<string>(""); // Estado para el input de recargos
// const inputTotalContribuciones = ref<string>(""); // Estado para el input de total de contribuciones
// const inputTotalAplicaciones = ref<string>(""); // Estado para el input de total de aplicaciones
// const inputCantidadACargo = ref<string>(""); // Estado para el input de cantidad a cargo
// const inputCantidadAPagar = ref<string>(""); // Estado para el input de cantidad a pagar
// const inputActividadesGravadasTasa16 = ref<string>(""); // Estado para el input de actividades gravadas a la tasa del 16%
// const inputActividadesGravadasTasa0 = ref<string>(""); // Estado para el input de actividades gravadas a la tasa del 0%
// const inputActividadesExentas = ref<string>(""); // Estado para el input de actividades exentas
// const inputIVACobradoPeriodoTasa16 = ref<string>(""); // Estado para el input de IVA cobrado del periodo a la tasa del 16%
// const inputIVAAcreditablePeriodo = ref<string>(""); // Estado para el input de IVA acreditable del periodo
// const inputIVARetenido = ref<string>(""); // Estado para el input de IVA retenido
// const selectedOptaPagarParcialidades = ref(null); // Estado para el input de optar por pagar en parcialidades
// const inputCantidadACargo2 = ref<string>(""); // Estado para el input de cantidad a cargo
// const inputImpuestoACargo2 = ref<string>(""); // Estado para el input de impuesto a cargo

// const inputACargo2 = ref<string>(""); // Estado para el input de a cargo
// const inputCantidadAPagar2 = ref<string>(""); // Estado para el input de cantidad a pagar
// const inputParteActualizada2 = ref<string>(""); // Estado para el input de parte actualizada
// const inputRecargos2 = ref<string>(""); // Estado para el input de recargos
// const inputTotalContribuciones2 = ref<string>(""); // Estado para el input de total de contribuciones
// const inputTotalAplicaciones2 = ref<string>(""); // Estado para el input de total de aplicaciones
...
const formEjercicio = ref({
    ...
    inputIngresoPeriodoAnterior: "",
    inputIngresoPeriodo: "",
    inputTotalIngresos: "",
    inputTotalIngresosAcumulables: "",
    inputComprasGastosPeriodoAnterior: "",
    inputComprasGastosPeriodo: "",
    inputTotalComprasGastos: "",

    inputDeduccionInversionesEjercicioAnterior: "",
    inputDeduccionInmediataInversiones: "",
    selectedDeduccionFacilidadesAdministrativas: "",
    inputParticipacionTrabajadoresUtilidades: "",
    inputBaseGravablePagoProvisional: "",
    ...
    inputACargo: "",
    inputParteActualizada: "",
    inputRecargos: "",
    inputTotalContribuciones: "",
    inputTotalAplicaciones: "",
    inputCantidadACargo: "",
    inputCantidadAPagar: "",
    inputActividadesGravadasTasa16: "",
    inputActividadesGravadasTasa0: "",
    inputActividadesExentas: "",
    inputIVACobradoPeriodoTasa16: "",
    inputIVAAcreditablePeriodo: "",
    inputIVARetenido: "",
    selectedOptaPagarParcialidades: "",
    inputCantidadACargo2: "",
    inputImpuestoACargo2: "",

    inputACargo2: "",
    inputCantidadAPagar2: "",
    inputParteActualizada2: "",
    inputRecargos2: "",
    inputTotalContribuciones2: "",
    inputTotalAplicaciones2: "",
});

// Reglas de validación para el formulario completo
    ...
    formEjercicio: {
        inputRFC: {
            ...
            maxLength: helpers.withMessage(
                "El RFC no puede exceder los 13 caracteres",
                maxLength(13)
            ),
        },
    },
...
const v$ = useVuelidate(rules, { formEjercicio });
...
const GuardarEjercicio = async () => {
    try {
        ...
        if (isValid) {
            // Enviar datos
            console.log("Formulario válido", formEjercicio.value);
        } else {
